...
export const version: string = '1.7.0'; //need to retrieve this if possible, but have a default
 ...
 */
const LAST_MODIFIED_DATE_OF_DEFAULT_VERSION: string = 'Mon, 15 Nov 2021 14:26:17 GMT';
