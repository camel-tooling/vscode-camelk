...
![Apache Camel K Extension Settings](images/camelk-integrations-view-settings.png)
...
* **Operator id** - Camel K can be installed with different operator id allowing multi-tenancies and mixing versions of Camel K on same cluster. The operator id can be specified in this case with this setting. If provided, all operations using `kamel` CLI underneath will use it.
